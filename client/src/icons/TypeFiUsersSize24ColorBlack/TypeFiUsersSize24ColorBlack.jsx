...
export const TypeFiUsersSize24ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`type-fi-users-size-24-color-black ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
...
export default TypeFiUsersSize24ColorBlack;